...
describe 'app', type: :feature, js: true do
  ...
  it 'demonstrates timing sensitive DOM interaction with async JavaScript' do
    ...
    # Validate text change deterministically by targeting the element
    expect(find('#welcome')).to have_text('Hi, Thank you for touch me!')
    expect(find('#welcome')).to have_no_text('Hello, Thank you for accessing to this website.')
  end
end
