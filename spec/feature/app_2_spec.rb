...
describe 'app_2', type: :feature, js: true do
  it 'app_2 clicks greeting to change welcome message' do
    ...
    expect(page).to have_no_selector('#welcome', text: 'Hi, Thank you for touch me!')
    click_on 'Greeting!'
    expect(page).to have_no_selector('#welcome', text: 'Hello, Thank you for accessing to this website.')
